...
Type a name and a URL and the paint style will appear in your Map Paint Styles window. 

There are four colors you may see, corresponding to the errors mentioned earlier: 
